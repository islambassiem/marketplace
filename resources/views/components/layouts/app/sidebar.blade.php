...
<html lang="{{ app()->currentLocale() }}" dir="{{ app()->currentLocale() === 'ar' ? 'rtl' : 'ltr' }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 font-alexandria">
        ...
        <div class="px-6 lg:px-8 h-[55px] flex items-center justify-end border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            @livewire('set-locale')
        ...
        <flux:sidebar sticky class="border-r rtl:border-l border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
