...
<body class="min-h-screen bg-white dark:bg-zinc-800 font-alexandria">
    <x-mary-toast />
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 gap-2">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item class="text-zinc-800! dark:text-zinc-200!" icon="star" :href="route('favorites.index')"
